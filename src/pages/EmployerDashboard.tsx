...
import { TalentSearch as TalentSearchPage } from './TalentSearch'
import { Subscription } from './Subscription'
import { Billing } from './Billing'
import { LogoutModal } from '../components/LogoutModal'
import { useEmployerStats } from '../hooks/useEmployerStats'
import './EmployerDashboard.css'
import { WalkInDrivesEmployer } from './WalkInDrivesEmployer'
...
function EmployerDashboard({ onLogout }: EmployerDashboardProps) {
  ...
  const handleViewJobPost = (jobId?: string, jobTitle?: string) => {
    setHighlightedJobId(jobId || jobTitle || null)
    ...
    <div className="dashboard-layout">
      ...
      <div className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          {activeMenu === 'walk-in-drives' && <WalkInDrivesEmployer />}

          {activeMenu === 'applicants' && (
            <ApplicantsPage
              onBrowseJobs={() => setActiveMenu('my-jobs')}
          ...
          {activeMenu === 'subscription' && (
            <Subscription 
              ...
              onNavigateToBilling={() => setActiveMenu('billing')}
            />
          )}
          {activeMenu === 'billing' && (
            <Billing
              ...
              <div className="metrics-grid">
                <div className="metric-card">
                  ...
                  <div className="metric-header">
                    ...
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="metric-icon" aria-hidden="true">
                ...
                <div className="metric-card">
                  ...
                  <div className={`metric-trend ${stats.applicantsThisMonth > 0 ? 'positive' : 'neutral'}`}>
                    {stats.applicantsThisMonth > 0 ? (
                      <>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                          <path d="M23 6l-9.5 9.5-5-5L1 18" />
                          <path d="M17 6h6v6" />
                        </svg>
                        +{stats.applicantsThisMonth} this month
                      </>
                    ) : (
                      <>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                ...
                <div className="metric-card">
                  ...
                  <div className={`metric-trend ${
                    stats.hiresThisMonth > stats.previousMonthHires
                      ? 'positive'
                      : stats.hiresThisMonth < stats.previousMonthHires
                      ? 'negative'
                      : 'neutral'
                    ...
                    {stats.hiresThisMonth > stats.previousMonthHires ? (
                      <>
                        ...
                        +{stats.hiresThisMonth - stats.previousMonthHires} vs last month
                      </>
                    ) : stats.hiresThisMonth < stats.previousMonthHires ? (
                      <>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                        ...
                        -{stats.previousMonthHires - stats.hiresThisMonth} vs last month
                      </>
                    ) : (
                      <>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
